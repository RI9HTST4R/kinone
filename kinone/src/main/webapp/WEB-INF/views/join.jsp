...
<div class="pagetitle"><span>K In One 회원가입</span></div>
<!-- 			<form id="regForm" action="join_ok.do" method="post"> -->
<br/>
<form>
	<div class="tab1">
		<h3>이용 약관</h3>
		<iframe src="${url}/resources/etc/contract1.txt" width="100%"
			height="400" scrolling="yes"></iframe>
		<br>
		<br>
		<br>
		<p>
			<label for="contract_check">본인은 위 약관을 모두 읽었으며,약관에 동의합니다.</label>&nbsp;&nbsp;&nbsp;<input type="checkbox"
				id="contract_check" style="width: 17px; height: 17px;">
		</p>
	</div>
	<div class="tab2">
		<h3>로그인 정보 입력</h3>
	...
	<div class="tab4">
		<h3>이메일 인증</h3>
		<p>
			<input type="text" placeholder="이메일 인증번호를 입력하세요."
				id="email_send_check" oninput="this.className = ''"
				name="email_send_check">
		</p>
	</div>
